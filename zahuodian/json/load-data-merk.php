...
';
		...
		array(
	       ...
	       'formatter' => function( $d ) {
	       return '
    <a href="modul/merk/aksi_merk.php?module=merk&act=hapus&id='.$d.'" class="btn btn-sm btn-danger" title="Delete"><span class="glyphicon glyphicon-trash"></span></a>';
    }
),
);
...
$extraWhere = "`is_void` = 0 ";        
 if ($_GET['merk']!='') {
	$extraWhere .= "and merk like '".$_GET['merk']."%'";
}
echo json_encode(
