...
$columns = array(
	...
	array( 'db' => 'a.telp1_supplier', 'dt' => 4,  'field' => 'telp1_supplier'
	 ),
	array( 'db' => 'a.telp1_sales', 'dt' => 5,  'field' => 'telp1_sales'
	 ),
	array(
	       'db'        => 'a.tambah',
	       'dt'        => 6,
...
$joinQuery = "FROM (select `id_supplier`,concat('".$module."&act=tambah&id=',id_supplier) as tambah,`kode_supplier`,`nama_supplier`,`jenis`,`alamat_supplier`,`region`,`telp1_supplier`,`telp1_sales` from master_supplier s,master_region r where r.id_region=s.id_region and s.`is_void` = 0)  a";     
