...
$columns = array(
	...
	array('db' => '`u`.`id_customer`', 'dt' => 8, 'field' => 'detail', 'as' => 'detail',
		'formatter' => function($d){
		$detail ="<a href='?module=laporanpenjualan&act=detail&id=$d' class='btn btn-sm btn-success' title='Detail' target='_blank'><span class='glyphicon glyphicon-list'></span></a>";
		return $detail;
		} )
);
...
$joinQuery = "FROM (SELECT  t.id_customer,t.tgl_update as tgl_update,
t.tgl,
