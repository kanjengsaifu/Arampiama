<?php
 ...
 include "../../lib/input.php";
   ...
   switch($_GET['jpr']){
          ...
          $kode_pembayaran= kode_pembayaran($kode[id_pembayaran],"BBM");
          ...
          echo'
             ...
             <tr class="bg-warning">
                ...
                <td><input id="jatuh_tempo" name="jatuh_tempo" class="datepicker form-control" required></td>
              </tr>
              <tr class="bg-warning">
                <td>No. Rekening Tujuan</td>
                <td><input id="no_rek" name="no_rek" class="form-control" required></td>
          ...
          $kode=mysql_fetch_array($query);
          $kode_pembayaran= kode_pembayaran($kode[id_pembayaran],"BGM");
