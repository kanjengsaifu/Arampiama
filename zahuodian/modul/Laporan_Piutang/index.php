...
$aksi="modul/laporanpiutang/aksi_laporanpiutang.php";
...
switch($_GET['act']){
  ...
  $desk = "Menampilkan Rekap Piutang Pada Customer";
...
<div class="input-group">
    <input type="hidden" class="form-control" id="caribaranginput" name="barang" value=""> 
     <input  type="text" class="form-control xHeightForm-control hasDatepicker" id="caribaranginput1" name="barang1" value="" readonly> 
          <span class="input-group-btn">
              <button class="btn btn-success xHeightForm-control" id="caribarangbutton"  type="button" style="padding:0px 12px;"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
              <button class="btn btn-warning xHeightForm-control" id="caribarangnull"  type="button" style="padding:0px 12px;">( )</button>
          </span>
</div>';
echo '</div>';

echo "
          <div class='col-md-2'><label>Tanggal Mulai: </label><input id='minrangekartubarang' name='min' class='datepicker xHeightForm-control'></div>
           <div class='col-md-2'><label>Sampai :</label> <input id='maxrangekartubarang' name='max' class='datepicker xHeightForm-control'></div>
           <div class='col-md-1'>
          <button id='carikartubarang' class='btn btn-primary allsupbuah' ><b>Cari</b> <span class='glyphicon glyphicon-search' aria-hidden='true'></span></button></div>
           <div class='col-md-1'>
          <button type='button' class='btn btn-success allsupbuah' data-toggle='modal' data-target='#myModal'>Kunci piutang</button></div>
  ...
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      <div class='modal-header'>
        ...
        <h4 class='modal-title'>Kunci piutang</h4>
      </div>
      ...
      <tr>
      <td>
      <form method='post' action='$aksi?module=laporanpiutang&act=generate' enctype='multipart/form-data'>
      kunci bulan :</td>
      <td>
...
case "detail":
 ...
 $judul = "Kartu Piutang";
  $desk = "Menampilkan Rekap Piutang Pada Customer $r[nama_customer]";
  headerDeskripsi($judul,$desk);
...
<script type="text/javascript">
 ...
 $.fn.dataTableExt.oApi.fnPagingInfo = function (oSettings)
                                   ...
                                   var t = $('#modalbarang').DataTable({
                                       ...
                                       "ajax": {
                                                "url": "modul/laporanpiutang/load-data.php",
                                                "cache": false,
                                                "type": "GET",
 ...
 function data_detail(s,a,k){
                        $.fn.dataTableExt.oApi.fnPagingInfo = function (oSettings)
                                   ...
                                   var t = $('#kartubarang').DataTable({
                                        ...
                                        "processing": true,
                                        "serverSide": true,
                                          "columnDefs": [{"className": "dt-right", "targets": [3,4,5,6]},{"className": "dt-left", "targets": [1,2]}],
                                       /* "ajax" : "modul/pembayaran/load-data_girotransaksi.php",*/
                             "ajax": {
                          "url": "modul/laporanpiutang/load-data_detail.php",
                          "cache": false,
                                "type": "GET",
                          "data":  {"barang": s,
                                          "awal" : a,
