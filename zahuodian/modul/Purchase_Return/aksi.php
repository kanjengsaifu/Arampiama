...
$query=mysql_query("SELECT * FROM `trans_retur_pembelian_detail` trpd,trans_retur_pembelian trp  WHERE trp.kode_rbb=trpd.kode_rbb and trp.kode_rbb='$_GET[kode]' ");
 while ( $r=mysql_fetch_array($query)){
      ...
      $no_invoice=$r['no_invoice'];
        ...
        mysql_query($delete);
        $query="DELETE a.* , b.* FROM `trans_retur_pembelian_detail` a, `trans_retur_pembelian` b WHERE a.kode_rbb=b.kode_rbb and a.kode_rbb='".$_GET['kode']."'";
...
input_jurnal_umum('71',$data['id_akunkasperkiraan'],'1','',$_POST['total'][$i],$kode_retur,$_POST['tgl_retur'],$supplier[0],'supplier');
