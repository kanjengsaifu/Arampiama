...
$joinQuery = "FROM (select `id_supplier`,`kode_supplier`,`nama_supplier`,`jenis`,`alamat_supplier`,`region`,`telp1_supplier`,`telp1_sales` from supplier s,region r where r.id_region=s.id_region and s.`is_void` = 0 and jenis='A')  a";     
