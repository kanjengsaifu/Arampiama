...
$columns = array(
	...
	array( 'db' => 'stok_minimum',  'dt' => 4, 'field' => 'stok_minimum',
	...
	array(
	       ...
	       return '<a class="btn-sm btn-success" href="#" onclick="click_view_nota(\''.$d.'\')"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a>';
    }
),
);
...
$joinQuery = "FROM `barang` AS `u` JOIN `stok` AS `ud` ON (`ud`.`id_barang` = `u`.`id_barang`) ";
