...
$columns = array(
	...
	array(
	       ...
	       'formatter' => function($d) {
	       	 return '<a class="btn-sm btn-success" href="#" onclick="add_invoice(\''.$d.'\')"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a>';
    })
);
...
$joinQuery = "FROM (SELECT *,concat('".$id_invoice."','@',id_akunkasperkiraan) as aksi FROM `akun_kas_perkiraan` WHERE `is_void`='0') a";
