...
$columns = array(
	...
	array('db' => '`u`.`tgl_giro_cair`',  'dt' => 5 , 'field' => 'tgl_giro_cair' ),
...
require( '../../lib/scripts/ssp.customized.class.php' );
	...
	$joinQuery = "FROM (SELECT akp.id_akunkasperkiraan,nama_akunkasperkiraan,tgl_giro_cair,tgl_pembayaran as tanggal,bukti_bayar,no_giro,jatuh_tempo,
CONCAT(status_giro,'-',nominal,'-',giro_ditolak)as status
 FROM trans_bayarbeli_header tbh,akun_kas_perkiraan akp
where akp.id_akunkasperkiraan=tbh.id_akunkasperkiraan and bukti_bayar like 'BGK%' and tbh.is_void='0') u";
	$extraWhere="";
