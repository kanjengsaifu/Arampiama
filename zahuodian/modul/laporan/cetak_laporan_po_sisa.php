...
<tr>
<th colspan="3"  style="font-size: 26px;">Laporan Sisa Purchase Order</th>
</tr>
<tr >
...
$query="SELECT harga,satuan,tpod.id as urut,tgl_po,tpo.id_pur_order,'' as id_lpb,nama_barang,jumlah,jumlah as qty,(jumlah*kali) as po_convert,'' as lpb_qty,'' as lpb_convert FROM `trans_pur_order_detail` tpod,`trans_pur_order` tpo,barang b where tpo.id_pur_order=tpod.id_pur_order and b.id_barang=tpod.id_barang and status_trans=1 order by id_pur_order,urut";
