...
<tbody>';
$query = "SELECT tgl_rbb as tgl,kode_rbb as nota,grandtotal_retur FROM `trans_retur_pembelian` where no_invoice =0 and is_void=0 and tgl_rbb >='".$awal."' and tgl_rbb <='".$akhir."' and
