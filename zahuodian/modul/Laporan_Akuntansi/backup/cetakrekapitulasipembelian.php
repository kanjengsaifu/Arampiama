...
<tbody>';
$query=mysql_query("SELECT * FROM `trans_invoice` WHERE is_void=0 and tgl_update >='".$awal."' and tgl_update  <='".$akhir."' and id_supplier= '".$id_supplier."' order by id_invoice");
...
while ($tampil=mysql_fetch_array($query)) {
  $temp=1;
$squery="SELECT *,total as jumlah_netto FROM `trans_invoice_detail` t,barang b WHERE b.id_barang=t.id_barang and id_invoice='".$tampil['id_invoice']."'";
