...
// DB table to use
$table = 'adjustment_stok';

// Table's primary key
$primaryKey = 'id_adjustment';
...
$columns = array(
	...
	array(
	       ...
	       return '
	       <!-- <a href="?module=adjustment&act=editmenu&id='.$d.' " class="btn btn-sm btn-warning" title="Edit"><span class="glyphicon glyphicon-edit"></span></a>-->
    <a href="modul/adjustment/aksi_adjustment.php?module=adjustment&act=hapus&id='.$d.' " class="btn btn-sm btn-danger" title="Delete"><span class="glyphicon glyphicon-trash">';
