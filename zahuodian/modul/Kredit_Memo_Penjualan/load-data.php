...
// parameter names
$columns = array(
	array('db' => '`u`.`kode_rjb`', 'dt' => 0, 'field' => 'kode_rjb' ),
	array('db' => '`u`.`kode_rjb`', 'dt' => 1, 'field' => 'kode_rjb' ),
...
$joinQuery = "FROM `trans_retur_penjualan` AS `u` JOIN `trans_sales_invoice` AS `ud` ON (`ud`.`id_invoice` = `u`.`no_invoice_terretur`)";
